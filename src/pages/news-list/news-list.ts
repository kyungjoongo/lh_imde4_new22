...
export class NewsListPage {
    ...
    totalPage = 0;
    selectedIndex = [];
    naver_url = "http://kyungjoon.ipdisk.co.kr:5000/naver_news_list?query=주택 청약 정보&page=";
    naver_url_remote = "https://checkout002-191623.appspot.com/naver_news_list?query=주택 청약 정보&page=";
    plxabayUri = 'https://pixabay.com/api/?key=7259916-f3ce173538d4a7f0dee3e23a0&category=travel&image_type=photo&pretty=true&per_page=10&page='
